...
namespace CrazyGames
{
    public class CrazyUser : Singleton<CrazyUser>
    {
        ...
        /// You can customize the user returned in the editor in the CrazyGamesSettings files.
        /// </summary>
        ...
        /// </summary>
        public void GetToken(Action<string, string> callback)
        {
            if (Application.isEditor)
            {
                var settings = CrazySDK.Instance.GetSettings();
        ...
        /// This requires game approval, so please get in touch with us.
        /// Callback param1 = error message (null if everything is fine), param2 = token.
        /// </summary>
    ...
    public class PortalUser
    {
        ...
        {
            return base.ToString() + ": Id = " + id + ", Username = " + username + ", profile picture url = " +
                   profilePictureUrl;
        }
    }
}